...
OBJS += \
./esp8266-driver/TESTS/net/tcp_echo_parallel/main.o 

CPP_DEPS += \
./esp8266-driver/TESTS/net/tcp_echo_parallel/main.d 


# Each subdirectory must supply rules for building sources it contributes
esp8266-driver/TESTS/net/tcp_echo_parallel/%.o: ../esp8266-driver/TESTS/net/tcp_echo_parallel/%.cpp
	@echo 'Building file: $<'
