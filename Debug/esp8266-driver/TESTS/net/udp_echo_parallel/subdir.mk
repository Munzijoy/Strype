...
CPP_SRCS += \
../esp8266-driver/TESTS/net/udp_echo_parallel/main.cpp 

OBJS += \
./esp8266-driver/TESTS/net/udp_echo_parallel/main.o 

CPP_DEPS += \
./esp8266-driver/TESTS/net/udp_echo_parallel/main.d 


# Each subdirectory must supply rules for building sources it contributes
esp8266-driver/TESTS/net/udp_echo_parallel/%.o: ../esp8266-driver/TESTS/net/udp_echo_parallel/%.cpp
	@echo 'Building file: $<'
