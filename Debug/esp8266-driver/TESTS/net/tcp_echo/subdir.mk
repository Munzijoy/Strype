...
OBJS += \
./esp8266-driver/TESTS/net/tcp_echo/main.o 

CPP_DEPS += \
./esp8266-driver/TESTS/net/tcp_echo/main.d 


# Each subdirectory must supply rules for building sources it contributes
esp8266-driver/TESTS/net/tcp_echo/%.o: ../esp8266-driver/TESTS/net/tcp_echo/%.cpp
	@echo 'Building file: $<'
